...
//_\TLV
   ...
   //_|cpu
      //_@0
         ...
         assign CPU_imem_rd_addr_a0[31:0] = CPU_pc_a0[31:2];
      ...
      //_@1
         ...
         assign CPU_is_i_instr_a1 = CPU_instr_a1[6:2] ==? 5'b0000x ||
                       ...
                       CPU_instr_a1[6:2] ==? 5'b11001;         // short immediates and loads
         assign CPU_is_r_instr_a1 = CPU_instr_a1[6:2] ==? 5'b01011 ||
                       CPU_instr_a1[6:2] ==? 5'b011x0 ||
                       CPU_instr_a1[6:2] ==? 5'b10100;         // register-register
         assign CPU_is_s_instr_a1 = CPU_instr_a1[6:2] ==? 5'b0100x;         // Store
         assign CPU_is_b_instr_a1 = CPU_instr_a1[6:2] ==? 5'b11000;         // Branch
         assign CPU_is_j_instr_a1 = CPU_instr_a1[6:2] ==? 5'b11011;         // Jump
         assign CPU_is_u_instr_a1 = CPU_instr_a1[6:2] ==? 5'b0x101;         // Long immediates
      ...
      //_@2
         ...
         assign CPU_jalr_tgt_pc_a2[31:0] = (CPU_src1_value_a2 + CPU_imm_a2) & 32'hFFFFFFFE;
   ...
   //  o CPU visualization
   //_|cpu
      //_\source /raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv 19   // Instantiated from riscv.tlv, 227 as: m4+imem(@1)
      ...
      //_\source /raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv 74   // Instantiated from riscv.tlv, 228 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv 91   // Instantiated from riscv.tlv, 229 as: m4+dmem(@4)
         // Data Memory
         //_@4
      ...
      //_\source /raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv 104   // Instantiated from riscv.tlv, 230 as: m4+myth_fpga(@0)
         //_@0
            /*SV_plus*/
               
               always @ (posedge clk) begin    
                  reg0  = CPU_Xreg_value_a5[0];          
                  reg1  = CPU_Xreg_value_a5[1];
                  reg2  = CPU_Xreg_value_a5[2];
                  reg3  = CPU_Xreg_value_a5[3];
                  reg4  = CPU_Xreg_value_a5[4];
                  reg5  = CPU_Xreg_value_a5[5];      
                  reg6  = CPU_Xreg_value_a5[6];
                  reg7  = CPU_Xreg_value_a5[7];
                  reg8  = CPU_Xreg_value_a5[8];          
                  reg9  = CPU_Xreg_value_a5[9];
                  reg10 = CPU_Xreg_value_a5[10];
                  reg11 = CPU_Xreg_value_a5[11];
                  reg12 = CPU_Xreg_value_a5[12];
                  reg13 = CPU_Xreg_value_a5[13];      
                  reg14 = CPU_Xreg_value_a5[14];
                  reg15 = CPU_Xreg_value_a5[15];
                  reg16 = CPU_Xreg_value_a5[16];          
                  reg17 = CPU_Xreg_value_a5[17];
                  reg18 = CPU_Xreg_value_a5[18];
                  reg19 = CPU_Xreg_value_a5[19];
                  reg20 = CPU_Xreg_value_a5[20];
                  reg21 = CPU_Xreg_value_a5[21];      
                  reg22 = CPU_Xreg_value_a5[22];
                  reg23 = CPU_Xreg_value_a5[23];
                  reg24 = CPU_Xreg_value_a5[24];          
                  reg25 = CPU_Xreg_value_a5[25];
                  reg26 = CPU_Xreg_value_a5[26];
                  reg27 = CPU_Xreg_value_a5[27];
                  reg28 = CPU_Xreg_value_a5[28];
                  reg29 = CPU_Xreg_value_a5[29];      
                  reg30 = CPU_Xreg_value_a5[30];
                  reg31 = CPU_Xreg_value_a5[31];
               end
               
      //_\end_source
   //_\source /raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv 144   // Instantiated from riscv.tlv, 231 as: m4+cpu_viz(@4)
